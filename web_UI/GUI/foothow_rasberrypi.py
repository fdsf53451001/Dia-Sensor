# following code only working on raspberry pi

import smbus
import RPi.GPIO as GPIO
from GUI.mlx90614 import MLX90614
import wiringpi
...
class Foothow_Rasberrypi:
    ...
    def move_motor_to_foot(self,i):
        self.move_motor_with_angle(self.servo_inner_pin,self.angle[0][0]+self.motor_offset[0])
        self.move_motor_with_angle(self.servo_outer_pin,self.angle[0][1]+self.motor_offset[1])
